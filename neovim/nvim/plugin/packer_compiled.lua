...
_G.packer_plugins = {
  ...
  ["editorconfig-vim"] = {
    loaded = true,
    path = "/Users/felix/.local/share/nvim/site/pack/packer/start/editorconfig-vim",
  ...
  ["gitlinker.nvim"] = {
    config = { "\27LJ\2\nR\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\1\rmappings\15<leader>gy\nsetup\14gitlinker\frequire\0" },
    loaded = true,
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lspconfig', 'indent-blankline.nvim', 'trouble.nvim', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
