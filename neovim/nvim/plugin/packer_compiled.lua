...
_G.packer_plugins = {
  ...
  ["vim-vsnip"] = {
    loaded = true,
    path = "/Users/felix/.local/share/nvim/site/pack/packer/start/vim-vsnip"
  },
  ["zen-mode.nvim"] = {
    after = { "twilight.nvim" },
    commands = { "ZenMode" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-lspconfig', 'trouble.nvim', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
